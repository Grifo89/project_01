...
import { db, Task, Project, ProjectMember, Priority } from '../services/db';
import { TaskCard } from '../components/TaskCard';
import { TaskDetailModal } from '../components/TaskDetailModal';
import { Search, Loader2, Inbox } from 'lucide-preact';
...
export const BacklogView = ({ currentProject }: { currentProject: Project | null }) => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // Backlog = unassigned tasks that are not archived
